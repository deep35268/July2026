...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6467566398 7675230405').split()] # Replace with the actual admin ID(s) to add
...
# ============================
# Server & Web Configuration (SIMPLIFIED)
# ============================

# 🔥 FQDN from environment (Render/Koyeb) or fallback to your Render URL
FQDN = environ.get("FQDN", "july2026.onrender.com")   # without https://
URL = f"https://{FQDN}/"   # ✅ Correct URL with trailing slash

# Keep other server variables if needed (but we simplify)
